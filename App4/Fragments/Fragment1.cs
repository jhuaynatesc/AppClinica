...
namespace App4.Fragments
{
    public class Fragment1 : SupportFragment
    {
        ...
        {
            var values = GetRandomSubList(Especialidades.EspecialidaesStrings,10);
        ...
        public class SimpleStringRecyclerViewAdapter : RecyclerView.Adapter
        {
            ...
            public override async void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                int drawableID = Especialidades.RadomEspecialidades;
                ...
                else
                {
                    ...
                    options.InSampleSize = Especialidades.CalculateInSampleSize(options, 100, 100);
